        ...
        "/v1/tracking/fast-segments": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Sensitivity: soft, normal, strict",
                        "name": "preset",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "integer",
                        "description": "Result count: 5, 10, 20",
                        "name": "limit",
                        "in": "query",
                        "required": true
                    }
